...
def show_landing():
    ...
    * { font-family: 'Plus Jakarta Sans', -apple-system, sans-serif; box-sizing: border-box; }
    ...
    <div class="navbar">
        ...
        <a href="#" class="nav-links"><a href="#" class="nav-cta">Try for Free →</a></a>
    </div>
    ...
    <div class="hero">
        ...
        <div class="hero-btns">
            <a href="#" class="btn-green" id="heroStart">✨ Start Writing Free</a>
    ...
    <div class="cta-section">
        <div style="position:relative;z-index:1">
            ...
            <a href="#" class="btn-green" id="ctaBtn">✨ Start Writing for Free</a>
